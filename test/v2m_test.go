...
var vditorDOM2MdTests = []parseTest{
	...
	{"104", "<p data-block=\"0\">\u200b<span class=\"vditor-wysiwyg__block\" data-type=\"html-inline\"><code data-type=\"html-inline\">\u200b&lt;foo&gt;</code><span class=\"vditor-wysiwyg__preview\" data-render=\"1\" data-html=\"&amp;lt;foo&amp;gt;\">....</span></span>\u200b	bar<wbr>\n</p>", "<foo>\tbar\n"},
...
var vditorIRDOM2MdTests = []parseTest{
	...
	{"0", "<p data-block=\"0\"><span data-type=\"inline-node\" class=\"vditor-ir__node\"><span class=\"vditor-ir__marker\">*</span><em data-newline=\"1\">foo</em><span class=\"vditor-ir__marker\">*</span></span>\n</p>", "*foo*\n"},
}
